...
func _on_export_hierarchy(selected_node: Node, include_scripts: bool, include_properties: bool, include_signals: bool) -> void:
	# Process the scene to get the hierarchy starting from the selected node
	var node_data = scene_processor.process_scene(selected_node, include_properties, include_signals)
